...
⑤ 作成とキャンセル  
シミュレーションモデル名が入力され、3D都市モデルと解析対象地域が選択された状態で追加ボタンを押下すると、新規シミュレーションモデルが本システムに登録されます。\
戻るを押下した場合、[2-5 シミュレーションモデル一覧画面 ] に遷移します。
...
3. 次に、[ 2-5 シミュレーションモデル一覧画面 ]で、シミュレーションモデルを選択し、編集ボタンを押下します。
