...
class Message extends \Eloquent
{
    ...
    public static $E5 = "対象行についてシミュレーションの実行ステータスが「%s」ではありません。<br>「%s」";
    ...
    public static $E11 = "OBJファイルまたはSTLファイルが選択されていません。";
    ...
    public static $E16 = "解析対象地域が選択されていません。" ;
    public static $E17 = "この3D都市モデルについてOBJファイルまたはSTLファイルが未登録です。" ;
    public static $E18 = "解析に必要なOBJファイルまたはSTLファイルが%sに登録されていません。" ;
    ...
    public static $E31 = "削除対象のモデルを選択してください。" ;
    public static $E32 = "作成対象の%sを入力してください。" ;
    public static $E33 = "プレビューボタンから作成対象の%sのプレビューを表示してください。" ;
    public static $E34 = "API呼び出し時にエラーが発生しました。再度お試しください。" ;
    public static $E35 = "該当の3D都市モデルを編集中です。時間を空けて再度お試しください。" ;
    public static $E36 = "デフォルトの最高・最低値は設定されていません。" ;
    public static $E37 = "「%s」の削除に失敗しました。時間を空けて再度お試しください。";
    public static $E38 = "「%s」の削除に一部失敗しました。システムの利用に影響はありません。";
    public static $E39 = "下記、いずれかを修正してください。<br>樹冠直径は". Constants::CANOPY_DIAMETER_DEFAULT ."m以上、高さは". Constants::CANOPY_HEIGHT_DEFAULT  . "m以上で入力してください。";
    ...
    public static $W4 = "削除を実行すると、解析対象地域「%1\$s」に関連するSTLファイルとシミュレーションモデルがすべて削除されます。「%1\$s」を削除してよろしいですか？";
    public static $W5 = "削除を実行すると、3D都市モデル「%1\$s」に関連する解析対象地域、STLファイルおよびシミュレーションモデルがすべて削除されます。「%1\$s」を削除してよろしいですか？";
    ...
    public static $I9 = "この解析対象地域はすでにシミュレーションモデルを実行済みのため、編集ができません。編集をする場合は、対象の解析対象地域に対して「複製」ボタンを押下し、複製された新規のレコードに対して編集を実施してください。";
